...
class PaparazziScreenshotsTest {
    ...
    fun onboarding_shell() {
        paparazzi.snapshot(name = "02_onboarding_shell") {
            LayoutInflater.from(context).inflate(R.layout.activity_onboarding, null, false)
        }
    }
    ...
    fun settings() {
        paparazzi.snapshot(name = "03_settings") {
            LayoutInflater.from(context).inflate(R.layout.activity_settings, null, false)
        }
    }
    ...
    fun guard_intervention() {
        paparazzi.snapshot(name = "04_guard_intervention") {
            LayoutInflater.from(context).inflate(R.layout.activity_guard_intervention, null, false)
        }
    }
